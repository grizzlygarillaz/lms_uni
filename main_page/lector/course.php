...
?>
    ...
    <div id="lector_edit" class="jumbotron p-4 mb-2 p-md-2 text-white bg-dark">
        ...
        {
            echo '
                        <a class="list-group-item list-group-item-action bg-light" methods="get" href="lector_test.php?t_id=' . $testId . '" style="padding: 12px 12px!important; width: 40% !important; max-width: 40%">
    ...
    <div class="list-group list-group-horizontal-sm">
        ...
        <div class="list-group   w-100 mr-md-3">
            ...
            <?php
            $topic = $sql->query("SELECT * from lecture  Where course_id =' " . $_GET['id'] . "' ");
