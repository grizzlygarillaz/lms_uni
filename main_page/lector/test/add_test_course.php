    ...
    <script>
        ...
        $(document).on('input','#answerTime',function () {
            ...
            $(document).on('click','#goEdit',function () {
                window.location.replace("edit/test_edit.php?course="+courseId+"");
            })

            $(document).on('change','#course',function () {
                if ($("#course option:selected").attr('contain') == "true") {
                     courseId = $("#course option:selected").attr('value');
                    $("#exampleModal").modal();
            ...
            $(document).on('click','#saveTest',function () {
                $.get(
                    ...
                    {
                        course: $('select#course option:selected').attr('value'),
                ...
                $(".addTest_form").each(function () {
                    ...
                    let courseId = parseInt($('select#course option:selected').attr('value'));
